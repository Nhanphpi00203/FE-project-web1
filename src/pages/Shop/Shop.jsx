    ...
    <div>
      <div className="p-4  container mx-auto w-full h-[fit] md:flex  justify-between  md:mt-[50px]">
        ...
        <div className=" w-0  md:w-[25%] flex-col md:flex hidden ">
          ...
          <div>
            <div className="relative pt-1">
              <input
                type="text"
                className="outline-none border-b-2 border-gray-400 border-solid text-[16px] w-[95%] h-[40px] pl-1 "
                placeholder="Search..."
              />
            ...
            <select
              name=""
              id=""
              className="text-[16px] border-2 border-solid border-gray-400 rounded-sm mt-[30px]  w-[95%] h-[50px]"
            >
        ...
        <div
          ...
          className="flex justify-start space-x-2 items-center md:hidden  mt-[20px]"
        >
