        ...
        <div className="container mx-auto flex justify-center items-center py-[100px]">
            <div className="w-[500px]  h-[500px]">
                ...
                <div className=" text-center h-[50px] my-[50px] w-[500px] bg-[#EFEFEF] rounded flex justify-between items-center pl-1">
                    ...
                    {isregister ? <div className="text-center h-[50px] my-[50px] w-[500px] bg-[#EFEFEF] rounded flex justify-between items-center pl-1 mr-[10px]">
                        <div className="ease-in-out duration-300 bg-[white] w-[240px] h-[40px] rounded text-[18px] flex items-center justify-center shadow-md">
                            <p > Sign in</p>
                        </div>
                        <div  onClick={()=>setIsregister(false)} className="ease-in-out duration-300 cursor-pointer flex justify-center items-center w-[240px] h-[40px] text-[18px]">
                            <p> Register</p>
                        </div>
                    </div>
                        :
                        <div className=" text-center h-[50px] my-[50px] w-[500px] bg-[#EFEFEF] rounded flex justify-between items-center pl-1">
                            <div onClick={()=>setIsregister(true)} className="cursor-pointer w-[240px] h-[40px] rounded text-[18px] flex items-center justify-center ">
                                <p > Sign in</p>
                            </div>
                            <div className="flex justify-center items-center w-[240px] h-[40px] text-[18px] shadow-md bg-[white] mr-[10px] rounded ">
                                <p> Register</p>
                            </div>
                        </div>
                    }
                ...
                :
                <form className="">
                      <div> <input type="name" required placeholder="Name" className="border-solid border-b-2 border-[#D8D8D8] text-[17px] outline-none p-1 w-[500px] my-[10px]" /></div>
                <div> <input type="email" required placeholder="Email" className="border-solid border-b-2 border-[#D8D8D8] text-[17px] outline-none p-1 w-[500px] my-[10px]" /></div>
                <div ><input type="password" required placeholder="Password" className="border-solid border-b-2 border-[#D8D8D8] text-[17px] outline-none p-1 w-[500px] my-[10px]" /></div>
